...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/diego/.vscode/extensions/wallabyjs.console-ninja-1.0.451/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20dfc9f1882b5d66ea06edUUhbAUgDAlpUW1ZcUw4EBwgPXAUF', mode: 'build'}); } catch(cjsError) { try { import('file:///home/diego/.vscode/extensions/wallabyjs.console-ninja-1.0.451/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20dfc9f1882b5d66ea06edUUhbAUgDAlpUW1ZcUw4EBwgPXAUF', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
